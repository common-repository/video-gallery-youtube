(function ($) {
    ...
    WaterMark.prototype.init = function () {
        ...
        WatermarkImage.css('display', 'none').attr('id', 'webpace_watermark_img_sample');
        if (!jQuery('body').find('#webpace_watermark_img_sample').length) {
        ...
        img.onload = function () {
            ...
            if (data.$wmObject) {
                ...
                if ($settings.text !== '') {
                    ...
                    $wmHeight = (jQuery('img#webpace_watermark_img_sample').prop('naturalHeight') * $wmWidth) / jQuery('img#webpace_watermark_img_sample').prop('naturalWidth');
                }
