...
function Webp_Gallery_Video_Thumbnails(id) {
    var _this = this;
    ...
    _this.naturalImageThumb = function () {
        _this.container.find(".webpace_big_li img").each(function (i, img) {
...
jQuery(document).ready(function () {
    jQuery(".webpace_videogallery.view-thumbnails").each(function (i) {
        var id = jQuery(this).attr('id');
        video_galleries[i] = new Webp_Gallery_Video_Thumbnails(id);
    });
});
