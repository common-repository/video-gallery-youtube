...
var name_changeTop = function (e) {
    document.getElementById("webpace_videogallery_name").value = e.value;
};
...
jQuery(document).ready(function () {
    ...
    jQuery('#webpace-insert-video-button').on('click',function () {
        var add_nonce = jQuery(this).parents('#webpace_gallery_video_add_videos_wrap').attr('data-add-video-nonce');
        var videoGalleryId = jQuery(this).parents('#webpace_gallery_video_add_videos_wrap').attr('data-videogallery-id');
        var action = 'admin.php?page=video_galleries_webpace_video_gallery&task=videogallery_video&id='+videoGalleryId+'&closepop=1&video_add_nonce='+add_nonce;
    ...
    jQuery('a.add-video-slide').on('click',function(){
        ...
        jQuery('#webpace_gallery_video_add_videos_wrap').attr('data-add-video-nonce',addVideoNonce);
        jQuery('#webpace_gallery_video_add_videos_wrap').attr('data-videogallery-id',videoGalleryId);
    });
    ...
    jQuery('.iframe-text-area').nextAll('a.edit-video-button').on('click', function () {
        ...
        var formAction = 'admin.php?page=video_galleries_webpace_video_gallery&task=gallery_video_edit_video&gallery_video_id=' + galleryVideoId + '&video_id='+videoUniqueId+'&video_url=' + videoUrl + '&TB_iframe=1&closepop=1&video_edit_nonce='+videoEditNonce;
    ...
    jQuery('.webpace-editnewuploader .editimgbutton ').click(function (e) {
    ...
    jQuery(".webpace-editnewuploader").click(function () {
    });
    ...
    jQuery('#webpace_sl_effects').change(function () {
    ...
    jQuery('#webpace_sl_effects').change();
});
