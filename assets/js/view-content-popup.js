...
//@todo natural images
function Webp_Gallery_Video_Content_Popup(id) {
    var _this = this;
    ...
    _this.addEventListeners = function () {
        ...
        _this.body.on('click', '#web-popup-overlay', _this.closePopup);
    ...
    _this.overlayClick = function () {
        ...
        jQuery('body').append('<div id="web-popup-overlay"></div>');
        _this.popupList.insertBefore('#web-popup-overlay');
        ...
        jQuery('#webpace_videogallery_pupup_element_' + strid).addClass('active').css({height: height * 0.7});
    ...
    _this.leftChange = function () {
        ...
        if (num >= 1) {
            ...
            _this.popupList.find('#webpace_videogallery_pupup_element_' + strid).css({height: height * 0.7});
    ...
    _this.closePopup = function () {
        jQuery('#web-popup-overlay').remove();
    ...
    _this.getResult = function (pagenum, perpage, galleryVideoId, linkbutton, showbutton, contentLoadNonce, changePopup) {
        var data = {
            action: "webpace_gallery_video_front_end_ajax",
...
jQuery(document).ready(function () {
    jQuery(".webpace_videogallery_container.view-content-popup").each(function (i) {
        var id = jQuery(this).attr('id');
        videoGalleries[i] = new Webp_Gallery_Video_Content_Popup(id);
    });
});
