"use strict";
function Webp_Gallery_Video_Playlist(id) {
    var _this = this;
    ...
    _this.AttachThumbClick = function (){
        jQuery('#'+id).children().find(".webpace_videogallery_item").on('click', function( event ) {
...
jQuery(document).ready(function () {
    jQuery(".main-playlist.view-playlist").each(function (i) {
        ...
        video_galleries[i] = new Webp_Gallery_Video_Playlist(id);
    });
});
