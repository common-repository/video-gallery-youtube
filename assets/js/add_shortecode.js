...
jQuery(document).ready(function () {
    ...
    jQuery('#webpacevideogalleryinsert').on('click', function () {
        var id = jQuery('#webpace_videogallery-select option:selected').val();
        var webpace_sl_effects = jQuery('#webpace_sl_effects').val();
        var sl = webpace_sl_effects;
        ...
        window.send_to_editor('[webpace_videogallery id="' + id + '"]');
        tb_remove();
    })
    ...
    jQuery('#webpace_videogallery-select').change(function () {
        ...
        jQuery.post(ajax_object_shortecode, data, function (response) {
            ...
            jQuery('#webpace_sl_effects').val(response.webpace_sl_effects);
            jQuery('#webpace_sl_effects').change();
