...
function Webp_Gallery_Video_Lightbox_Gallery(id) {
    var _this = this;
...
jQuery(document).ready(function () {
    jQuery(".webpace_videogallery_container.view-lightbox-gallery").each(function (i) {
        var id = jQuery(this).attr('id');
        video_galleries[i] = new Webp_Gallery_Video_Lightbox_Gallery(id);
    });
});
