...
/**
 * Class Webp_Gallery_Video_Widget
 */
class Webp_Gallery_Video_Widget extends WP_Widget {

	/**
	 * WebPace_gallery_Widget constructor.
	 */
	public function __construct() {
		parent::__construct(
			'Webpace_gallery_video_Widget',
			'Webpace Video Gallery',
			array( 'description' => __( 'Webpace Video Gallery', 'gallery-video' ), )
		);
	}
	...
	public function widget( $args, $instance ) {
		if ( isset( $instance['gallery_video_id'] ) ) {
			...
			echo do_shortcode( "[webpace_videogallery id={$gallery_video_id}]" );
