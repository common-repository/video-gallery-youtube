...
/**
 * Class Webp_Gallery_Video_Frontend_Scripts
 */
class Webp_Gallery_Video_Frontend_Scripts {

	/**
	 * Webp_Gallery_Video_Frontend_Scripts constructor.
	 */
	...
	public function frontend_styles( $id, $gallery_video_view ) {
        ...
        wp_register_style( 'gallery_video_resp_lightbox_css', untrailingslashit( webp_gallery_video()->plugin_url() ) . '/assets/style/responsive_lightbox.css' );
	...
	public function frontend_scripts( $id, $gallery_video_view, $has_youtube, $has_vimeo ) {
		$view_slug = webp_gallery_video_get_view_slag_by_id( $id );
        $gallery_video_get_option = webp_gallery_video_get_default_general_options();
		...
		wp_register_script( 'gallery-video-webpacemicro-min-js', plugins_url( '../../assets/js/jquery.webpacemicro.min.js', __FILE__ ), array( 'jquery' ), '1.0.0', true );
		wp_enqueue_script( 'gallery-video-webpacemicro-min-js' );
	...
	public function localize_scripts( $id ) {
		...
		$gallery_video_params = webp_gallery_video_get_default_general_options();
		...
		$has_youtube    = 'false';
		$has_vimeo      = 'false';
		$view_slug      = $view_slug = webp_gallery_video_get_view_slag_by_id( $id );
		...
		$gallery_video_get_option = webp_gallery_video_get_default_general_options();
		$gallery_video_view = $gallery_video[0]->webpace_sl_effects;
        $lightbox     = array(
