<section id="webpace_videogallery_content_<?php echo esc_attr($gallery_videoID); ?>" class="gallery-video-content"
         data-gallery-video-id="<?php echo esc_attr($gallery_videoID); ?>" data-gallery-video-perpage="<?php echo esc_attr($num); ?>">
    <div id="webpace_videogallery_container_<?php echo esc_attr($gallery_videoID); ?>"
         class="webpace_videogallery_container super-list variable-sizes clearfix view-<?php echo esc_attr($view_slug); ?>"
        ...
        <div id="webpace_videogallery_container_moving_<?php echo esc_attr($gallery_videoID); ?>">
            ...
            foreach ($page_videos as $key => $row) {
                ...
                <div
                    ...
                    id="webpace_videogallery_pupup_element_<?php echo $row->id; ?>_child" tabindex="0"
    ...
    if ($a == 1 && $num < $total_videos) {
        ...
        <div class="paginate5">
            ...
            $pervpage = '';
            if ($page != 1) {
                $pervpage = '<a href= ' . $checkREQ . '=1><i class="icon-style5 webpaceicons-fast-backward" ></i></a>  
	                               <a href= ' . $checkREQ . '=' . ($page - 1) . '><i class="icon-style5 webpaceicons-chevron-left"></i></a> ';
            }
            $nextpage = '';
            if ($page != $total) {
                $nextpage = ' <a href= ' . $checkREQ . '=' . ($page + 1) . '><i class="icon-style5 webpaceicons-chevron-right"></i></a>  
                                   <a href= ' . $checkREQ . '=' . $total . '><i class="icon-style5 webpaceicons-fast-forward" ></i></a>';
            }
...
<ul id="webpace_videogallery_popup_list_<?php echo esc_attr($gallery_videoID); ?>" class="hg_video_popup">
    <?php
    $changePopup = 1;
    foreach ($page_videos as $key => $row) {
        ...
        $result = substr($descnohtml, 0, 50);
        ?>
        <li class="pupup-element" id="webpace_videogallery_pupup_element_<?php echo esc_attr($row->id); ?>">
