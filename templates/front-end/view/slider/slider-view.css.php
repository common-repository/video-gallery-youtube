<style>
.webpace_slideshow_image_wrap_videogallery_<?php echo $gallery_videoID; ?> {
...
.webpace_slideshow_image_videogallery_<?php echo $gallery_videoID; ?> {
	/*width:100%;*/
}
...
#webpace_slideshow_left-ico_videogallery_<?php echo $gallery_videoID; ?>,
#webpace_slideshow_right-ico_videogallery_<?php echo $gallery_videoID; ?> {
	z-index: 13;
...
#webpace_slideshow_left-ico_videogallery_<?php echo $gallery_videoID; ?>:hover,
#webpace_slideshow_right-ico_videogallery_<?php echo $gallery_videoID; ?>:hover {
	cursor: pointer;
}
...
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> {
...
.webpace_slideshow_description_text_videogallery_<?php echo $gallery_videoID; ?> {
	text-decoration: none;
	position: absolute;
	z-index: 11;
	border-style:solid;
...
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?>.none, .webpace_slideshow_description_text_videogallery_<?php echo $gallery_videoID; ?>.none,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?>.hidden, .webpace_slideshow_description_text_videogallery_<?php echo $gallery_videoID; ?>.hidden	   {display:none;}

.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> h1, .webpace_slideshow_description_text_videogallery_<?php echo $gallery_videoID; ?> h1,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> h2, .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> h2,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> h3, .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> h3,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> h4, .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> h4,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> p, .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> p,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> strong,  .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> strong,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> span, .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> span,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> ul, .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> ul,
.webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> li, .webpace_slideshow_title_text_videogallery_<?php echo $gallery_videoID; ?> li {
	padding:2px;
	margin:0;
}

.webpace_slide_container_videogallery_<?php echo $gallery_videoID; ?> {
	display: table-cell;
	margin: 0 auto;
	position: relative;
	vertical-align: middle;
...
.webpace_slide_bg_videogallery_<?php echo $gallery_videoID; ?> {
	margin: 0 auto;
	width:100%;
	height:100%;
	_width: inherit;
...
.webpace_slider_videogallery_<?php echo $gallery_videoID; ?> {
	width:100%;
	height:100%;
	display:table;
	padding:0;
...
.webpace_slideshow_image_item_videogallery_<?php echo $gallery_videoID; ?> {
	width:100%;
	height:100%;
	width: inherit;
	height: inherit;
...
.webpace_slideshow_image_second_item_videogallery_<?php echo $gallery_videoID; ?> {
	width:100%;
	height:100%;
	_width: inherit;
	_height: inherit;
...
.webpace_grid_videogallery_<?php echo $gallery_videoID; ?> {
	display: none;
	height: 100%;
	overflow: hidden;
	position: absolute;
...
.webpace_gridlet_videogallery_<?php echo $gallery_videoID; ?> {
	opacity: 1;
	filter: Alpha(opacity=100);
	position: absolute;
}
...
.webpace_slideshow_dots_thumbnails_videogallery_<?php echo $gallery_videoID; ?> {
	margin: 0 auto;
	overflow: hidden;
	position: absolute;
	width:100%;
...
.webpace_slideshow_dots_videogallery_<?php echo $gallery_videoID; ?> {
	display: inline-block;
	position: relative;
	cursor: pointer;
...
.webpace_slideshow_dots_active_videogallery_<?php echo $gallery_videoID; ?> {
	opacity: 1;
	background:#0f0;
	filter: Alpha(opacity=100);
}
.webpace_slideshow_dots_deactive_videogallery_<?php echo $gallery_videoID; ?> {

}

.webpace_slideshow_image_item1_videogallery_<?php echo $gallery_videoID; ?> {
	display: table;
	width: inherit;
	height: inherit;
}
.webpace_slideshow_image_item2_videogallery_<?php echo $gallery_videoID; ?> {
	display: table-cell;
	vertical-align: middle;
	text-align: center;
}

.webpace_slideshow_image_item2_videogallery_<?php echo $gallery_videoID; ?> a {
	display:block;
	vertical-align:middle;
	width:100%;
	height:100%;
...
#webpace_slideshow_left_videogallery_<?php echo $gallery_videoID; ?>:hover {
	background-position:left -50px;
}

#webpace_slideshow_right_videogallery_<?php echo $gallery_videoID; ?>:hover {
...
.webpace_slideshow_image_wrap_videogallery_<?php echo $gallery_videoID; ?> .thumb_wrapper img{
