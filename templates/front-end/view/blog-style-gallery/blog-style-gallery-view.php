<div class="galery_video_view9_cont_list"
	...
	if ( $a == 1 && $num < $total_videos ) {
		...
		<div class="paginate">
			...
			$pervpage = '';
			if ( $page != 1 ) {
				$pervpage = '<a href= ' . $checkREQ . '=1><i class="icon-style webpaceicons-fast-backward" ></i></a>  
                               <a href= ' . $checkREQ . '=' . ( $page - 1 ) . '><i class="icon-style webpaceicons-chevron-left"></i></a> ';
			}
			$nextpage = '';
			if ( $page != $total ) {
				$nextpage = '<a href= ' . $checkREQ . '=' . ( $page + 1 ) . '><i class="icon-style webpaceicons-chevron-right"></i></a>  
                               <a href= ' . $checkREQ . '=' . $total . '><i class="icon-style webpaceicons-fast-forward" ></i></a>';
			}
