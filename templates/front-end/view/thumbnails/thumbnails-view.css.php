<style>
section #webpace_videogallery a{
	border:none;
}
section #webpace_videogallery {
...
#webpace_videogallery .webpace_big_li {
...
section #webpace_videogallery li .infoLayer ul li {
	max-height:80px;
	overflow:hidden;
}

section #webpace_videogallery li .overLayer ul li h2,
section #webpace_videogallery li .infoLayer ul li h2 {
...
section #webpace_videogallery li .infoLayer ul li p {
	color: #<?php echo $gallery_video_get_option["gallery_video_thumb_title_font_color"]; ?>;
	margin:0 !important;
}

section #webpace_videogallery li .overLayer,
section #webpace_videogallery li .infoLayer {
...
section #webpace_videogallery li a {
	position: absolute;
	display: block;
	width: 100%;
	max-width: <?php echo $gallery_video_get_option["gallery_video_thumb_image_width"]; ?>px;
...
section #webpace_videogallery li:hover .overLayer {
	-webkit-transition: opacity 0.3s linear;
	-moz-transition: opacity 0.3s linear;
	-ms-transition: opacity 0.3s linear;
	-o-transition: opacity 0.3s linear;
...
section #webpace_videogallery li:hover .infoLayer {
	-webkit-transition: opacity 0.3s linear;
	-moz-transition: opacity 0.3s linear;
	ms-transition: opacity 0.3s linear;
	-o-transition: opacity 0.3s linear;
...
section #webpace_videogallery p {text-align:center;}
</style>