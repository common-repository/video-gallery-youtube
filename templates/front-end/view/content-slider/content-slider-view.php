			...
			<div class="slider-content-wrapper">
				<div class="image-block_<?php echo $gallery_videoID; ?>">
					...
					if ( $videourl[1] == 'youtube' ) {
						...
						?>
						<a data-id="<?php echo $row->id; ?>" class="vyoutube webpace_videogallery_item group<?php echo $gallery_videoID; ?>"
						...
						?>
						<a class="vvimeo webpace_videogallery_item group<?php echo $gallery_videoID; ?>" data-id="<?php echo $row->id; ?>"
