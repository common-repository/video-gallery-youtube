<div id="my_video_gallery_wrapper_<?php echo esc_attr($gallery_videoID); ?>" class="clearfix gallery-video-content"
	...
	<div class="paginate2">
		...
		$pervpage = '';
		if ( $page != 1 ) {
			$pervpage = '<a href= ' . $checkREQ . '=1><i class="icon-style2 webpaceicons-fast-backward" ></i></a>  
                            <a href= ' . $checkREQ . '=' . ( $page - 1 ) . '><i class="icon-style2 webpaceicons-chevron-left"></i></a> ';
		}
		$nextpage = '';
		if ( $page != $total ) {
			$nextpage = '<a href= ' . $checkREQ . '=' . ( $page + 1 ) . '><i class="icon-style2 webpaceicons-chevron-right"></i></a>  
                           <a href= ' . $checkREQ . '=' . $total . '><i class="icon-style2 webpaceicons-fast-forward" ></i></a>';
		}
