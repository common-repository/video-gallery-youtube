<section id="webpace_videogallery_content_<?php echo esc_attr($gallery_videoID); ?>" class="gallery-video-content"
                ...
                <div data-id="<?php echo esc_attr($row->id); ?>"
                    ...
                    <div class="image-block_<?php echo esc_attr($gallery_videoID); ?>">
                        ...
                        if ($videourl[1] == 'youtube') {
                            ...
                            ?>
                            <a class="vyoutube webpace_videogallery_item group<?php echo esc_attr($gallery_videoID); ?>"
                            ...
                            ?>
                            <a class="vvimeo webpace_videogallery_item group<?php echo esc_attr($gallery_videoID); ?>"
    ...
    if ($a == 1 && $num < $total_videos) {
        ...
        <div class="paginate4">
            ...
            $pervpage = '';
            if ($page != 1)
                $pervpage = '<a href= ' . $checkREQ . '=1><i class="icon-style4 webpaceicons-fast-backward" ></i></a>  
                                   <a href= ' . $checkREQ . '=' . ($page - 1) . '><i class="icon-style4 webpaceicons-chevron-left"></i></a> ';
            $nextpage = '';
            if ($page != $total)
                $nextpage = ' <a href= ' . $checkREQ . '=' . ($page + 1) . '><i class="icon-style4 webpaceicons-chevron-right"></i></a>  
                                   <a href= ' . $checkREQ . '=' . $total . '><i class="icon-style4 webpaceicons-fast-forward" ></i></a>';
