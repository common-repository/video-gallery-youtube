<div id="webpace_videogallery" style="display:none;">
	<h3><?php _e( "Select Webpace Video Gallery to insert into post" ); ?></h3>
	<?php
	...
	if ( count( $shortcodevideogallerys ) ) {
		echo "<select id='webpace_videogallery-select' data-change-view-nonce='".$change_view_nonce."'>";
		...
		echo "</select>";
		echo "<button class='button button-primary' id='webpacevideogalleryinsert' data-insert-shortecode-nonce='".$insert_shortecode_nonce."'>Insert Video Gallery</button>";
	} else {
		echo "No slideshows found", "webpace_videogallery";
	}
	?>
	<div id="videogallery-unique-options" class="postbox">
		...
		<ul id="videogallery-unique-options-list">
			<li>
				<label for="webpace_sl_effects">Views</label>
