...
$lightbox_options_nonce = wp_create_nonce( 'webpace_gallery_nonce_save_lightbox_options' );
...
<div class="wrap">
    ...
    <div style="margin-left: -20px;position: relative" id="poststuff">
        <p class="pro_info">
            ...
            <a href="https://webpace.net/wordpress-video-gallery/" target="_blank" class="button button-primary"><?php _e('Enable', 'gallery-video');?></a>
        </p>
        <form
                action="admin.php?page=Options_video_gallery_lightbox_styles&task=save&webpace_gallery_nonce_save_lightbox_options=<?php echo esc_attr($lightbox_options_nonce); ?>"
